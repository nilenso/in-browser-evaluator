...
var digit_22464 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_22465__$1 = (vlq >>> (5));
while(true){
if((vlq_22465__$1 > (0))){
var digit_22466__$1 = (digit_22464 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_22466__$1));

var G__22467 = (vlq_22465__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__22468 = (vlq_22465__$1 >>> (5));
digit_22464 = G__22467;
vlq_22465__$1 = G__22468;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_22464));
}
break;
}
...
var G__22469 = i__$1;
var G__22470 = result__$1;
var G__22471 = shift__$1;
i = G__22469;
result = G__22470;
shift = G__22471;
continue;
