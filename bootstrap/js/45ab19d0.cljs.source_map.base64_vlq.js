...
var digit_22558 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_22559__$1 = (vlq >>> (5));
while(true){
if((vlq_22559__$1 > (0))){
var digit_22560__$1 = (digit_22558 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_22560__$1));

var G__22561 = (vlq_22559__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__22562 = (vlq_22559__$1 >>> (5));
digit_22558 = G__22561;
vlq_22559__$1 = G__22562;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_22558));
}
break;
}
...
var G__22564 = i__$1;
var G__22565 = result__$1;
var G__22566 = shift__$1;
i = G__22564;
result = G__22565;
shift = G__22566;
continue;
