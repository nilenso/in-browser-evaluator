...
var G__21908 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__21908;
continue;
} else {
return ch;
...
var vec__21894 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21894,(0),null);
return (match === s);
});
...
var G__21948 = (i__4737__auto___21943 + (1));
i__4737__auto___21943 = G__21948;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq21901){
...
return (function() { 
var G__21959__delegate = function (rdr,_){
...
var G__21959 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__21962__i = 0, G__21962__a = new Array(arguments.length -  1);
while (G__21962__i < G__21962__a.length) {G__21962__a[G__21962__i] = arguments[G__21962__i + 1]; ++G__21962__i;}
  _ = new cljs.core.IndexedSeq(G__21962__a,0,null);
} 
return G__21959__delegate.call(this,rdr,_);};
G__21959.cljs$lang$maxFixedArity = 1;
G__21959.cljs$lang$applyTo = (function (arglist__21967){
var rdr = cljs.core.first(arglist__21967);
var _ = cljs.core.rest(arglist__21967);
return G__21959__delegate(rdr,_);
});
