...
var digit_22465 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_22466__$1 = (vlq >>> (5));
while(true){
if((vlq_22466__$1 > (0))){
var digit_22467__$1 = (digit_22465 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_22467__$1));

var G__22468 = (vlq_22466__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__22469 = (vlq_22466__$1 >>> (5));
digit_22465 = G__22468;
vlq_22466__$1 = G__22469;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_22465));
}
break;
}
...
var G__22484 = i__$1;
var G__22485 = result__$1;
var G__22486 = shift__$1;
i = G__22484;
result = G__22485;
shift = G__22486;
continue;
