...
var digit_22495 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_22496__$1 = (vlq >>> (5));
while(true){
if((vlq_22496__$1 > (0))){
var digit_22497__$1 = (digit_22495 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_22497__$1));

var G__22498 = (vlq_22496__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__22499 = (vlq_22496__$1 >>> (5));
digit_22495 = G__22498;
vlq_22496__$1 = G__22499;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_22495));
}
break;
}
...
var G__22500 = i__$1;
var G__22501 = result__$1;
var G__22502 = shift__$1;
i = G__22500;
result = G__22501;
shift = G__22502;
continue;
