...
var digit_22460 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_22461__$1 = (vlq >>> (5));
while(true){
if((vlq_22461__$1 > (0))){
var digit_22462__$1 = (digit_22460 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_22462__$1));

var G__22463 = (vlq_22461__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__22464 = (vlq_22461__$1 >>> (5));
digit_22460 = G__22463;
vlq_22461__$1 = G__22464;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_22460));
}
break;
}
...
var G__22465 = i__$1;
var G__22466 = result__$1;
var G__22467 = shift__$1;
i = G__22465;
result = G__22466;
shift = G__22467;
continue;
