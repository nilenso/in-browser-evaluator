...
var digit_22462 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_22463__$1 = (vlq >>> (5));
while(true){
if((vlq_22463__$1 > (0))){
var digit_22464__$1 = (digit_22462 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_22464__$1));

var G__22465 = (vlq_22463__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__22466 = (vlq_22463__$1 >>> (5));
digit_22462 = G__22465;
vlq_22463__$1 = G__22466;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_22462));
}
break;
}
...
var G__22467 = i__$1;
var G__22468 = result__$1;
var G__22469 = shift__$1;
i = G__22467;
result = G__22468;
shift = G__22469;
continue;
