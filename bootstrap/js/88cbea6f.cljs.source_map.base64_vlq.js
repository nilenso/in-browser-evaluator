...
var digit_22466 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_22467__$1 = (vlq >>> (5));
while(true){
if((vlq_22467__$1 > (0))){
var digit_22468__$1 = (digit_22466 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_22468__$1));

var G__22469 = (vlq_22467__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__22470 = (vlq_22467__$1 >>> (5));
digit_22466 = G__22469;
vlq_22467__$1 = G__22470;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_22466));
}
break;
}
