...
var digit_22544 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_22545__$1 = (vlq >>> (5));
while(true){
if((vlq_22545__$1 > (0))){
var digit_22546__$1 = (digit_22544 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_22546__$1));

var G__22547 = (vlq_22545__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__22548 = (vlq_22545__$1 >>> (5));
digit_22544 = G__22547;
vlq_22545__$1 = G__22548;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_22544));
}
break;
}
...
var G__22549 = i__$1;
var G__22550 = result__$1;
var G__22551 = shift__$1;
i = G__22549;
result = G__22550;
shift = G__22551;
continue;
